<?php
// consa.php - Building A consultation page
session_start();
...
$batiment = 'A'; // Building identifier
...
// Get selected time period (default: 24 hours)
...
<main>
    ...
    <?php
    // Get sensor measurements for the selected building and time period
